...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            num_rendered, color, lanugage_feature, depth, alpha, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, lanugage_feature, radii, depth, alpha

    @staticmethod
    def backward(ctx, grad_color, grad_out_lanugage_feature, grad_radii, grad_depth, grad_alpha):
        ...
        grads = (
            ...
            grad_language_feature_precomp * raster_settings.confidence,
